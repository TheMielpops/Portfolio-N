...
import { ArrowLeft, Gamepad2, Crosshair, HeartPulse, Braces } from 'lucide-react';
import { useLanguage } from '@/context/LanguageContext';

export default function FpsSurvivalProject() {
  const { t, lang, toggleLang } = useLanguage();
  const proj = t.projectDetails.fpsSurvival;
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="border-t border-white/10 pt-8 grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-4"><h2 className="font-mono text-xs uppercase tracking-widest text-gray-500 flex items-center gap-3"><Gamepad2 size={16} className="text-accent" /> {proj.context}</h2></div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="border-t border-white/10 pt-8 grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-4"><h2 className="font-mono text-xs uppercase tracking-widest text-gray-500 flex items-center gap-3"><Crosshair size={16} className="text-accent" /> {proj.mechanics}</h2></div>
            <div className="md:col-span-8"><p className="text-lg leading-relaxed text-gray-300 font-light">{proj.mechanicsText}</p></div>
          </motion.div>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="border-t border-white/10 pt-8 grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-4"><h2 className="font-mono text-xs uppercase tracking-widest text-gray-500 flex items-center gap-3"><HeartPulse size={16} className="text-accent" /> {proj.systems}</h2></div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="border-t border-white/10 pt-8 grid grid-cols-1 md:grid-cols-12 gap-8">
            <div className="md:col-span-4"><h2 className="font-mono text-xs uppercase tracking-widest text-gray-500 flex items-center gap-3"><Braces size={16} className="text-accent" /> {proj.dev}</h2></div>
            <div className="md:col-span-8"><p className="text-lg leading-relaxed text-gray-300 font-light">{proj.devText}</p></div>
          </motion.div>
        </div>
      </div>
    </main>
